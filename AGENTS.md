...
| `docs/仿真架构说明-20260923.md` | 仿真架构：上游三大件取用范围、M1–M9 mock 清单与机制、请求生命周期真实事件走查；交互图 `docs/figures/fig_arch_platform.html`、`fig_seq_lifecycle.html`（archify，可编辑规格 `.json` 同目录）；走查复现 `mooncake-cpu-lab/scripts/lifecycle_demo.py` |
